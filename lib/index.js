  ...
  exports.accessibleBy = function(schema, options) {
    ...
    */
    ...
    schema.methods.grantAccess = function(actorOrActorId, roleOrRoles) {
      ...
      accessibleType = _findOrCreateAccessibleTypeForActor(this, actorOrActorId);
    ...
    schema.methods.revokeAccess = function(actorId, optionalRoles) {
      if (optionalRoles == null) optionalRoles = null;
      return this;
    };
    schema.methods.replaceAccess = function(actorId, optionalRoles) {
      if (optionalRoles == null) optionalRoles = null;
      return this;
    };
    /*
